...
<head>
    ...
    <style>
        ...
        #topbar {
            display: none; /* Tampilkan topbar secara default */
        }
        
        /* Media query untuk menyembunyikan topbar jika lebar layar >= 768px */
        @media (max-width: 768px) {
            #topbar {
                display: block; /* Sembunyikan topbar jika lebar layar >= 768px */
            }
        }
    </style>
</head>
