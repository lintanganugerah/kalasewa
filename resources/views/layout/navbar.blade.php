    ...
    <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse" id="collapse">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                @endif
                <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="{{ route('viewRules') }}">Rules</a>
                </li>
                <li class="nav-item">
            ...
            @else
                <a class="me-4" href="{{ route('jadiSellerView') }}"
                    style="color: #EE1B2F; text-decoration:none">Setup
                    Merch</a>
                <a class="me-4" href="{{ route('registerViewPenyewa') }}"
                    style="color: #EE1B2F; text-decoration:none">Register</a>
                <a class="me-5" href="{{ route('loginView') }}"
                    style="color: #EE1B2F; text-decoration:none">Login</a>
            @endif
        </div>
    </div>
</nav>
