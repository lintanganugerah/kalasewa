        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-6 text-start">
                    ...
                    <button type="button" class="btn btn-outline-dark mb-2">Size: {{ $produk->ukuran_produk }}</button>
                        ...
                        <div class="container">
                            <div class="card-body text-center">
                                ...
                                <div class="container-fluid d-flex justify-content-around">
                                    ...
                                    @elseif ($averageTokoRating > 0 && $averageTokoRating < 2.5) <span
                                        class="badge text-bg-danger">
                                        Bermasalah</span>
                                        @elseif ($averageTokoRating >= 2.5 && $averageTokoRating < 4) <span
                                            class="badge text-white" style="background-color: #EB7F01;">Standar</span>
                                            @else
                                ...
                                <div class="pilihan-user mt-2">
                                    ...
                                    <form action="{{ route('viewOrder', ['id' => $produk->id]) }}">
                                        @csrf
                                        @if (
                                        $produk->grade == 'Grade 3' && auth()->user()->total_review_penyewa() >= 3
                                        && auth()->user()->avg_nilai_penyewa() >= 4
                                        )
                                        <button type="submit" class="btn btn-danger w-100">Rental
                                            Produk</button>
                                        @elseif (
                                        $produk->grade == 'Grade 2' && auth()->user()->total_review_penyewa() >
                                        0
                                        )
                                        <button type="submit" class="btn btn-danger w-100">Rental
                                            Produk</button>
                                        ...
                                        <button type="submit" class="btn btn-danger w-100" disabled>Rental
                                            Produk</button>
                                        <span>Mengapa saya tidak bisa menyewa produk ini<a data-bs-toggle="modal"
                ...
                <div class="modal-body">
                    ...
                    <span class='text-danger'>
                        ...
                        <p>Sejauh ini, anda memiliki rating sebesar:
                            <strong>{{ number_format(auth()->user()->avg_nilai_penyewa(), 2) }}</strong> <br>dan baru
                            pernah
                            menyewa sebanyak:
