...
<body id="page-top">
    <nav class="navbar navbar-expand topbar shadow-lg kalasewa-color-topbar" id="topbar">
        ...
        <button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3" id="sidebar-toggle-btn" onclick="toggleSidebarVisibility()">
    ...
    <div id="wrapper">
        ...
        @include('layout-seller.sellsidebar')
