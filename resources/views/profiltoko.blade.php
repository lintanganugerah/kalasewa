                                ...
                                <form action="{{ route('seller.profilTokoAction') }}" method="POST"
                                    ...
                                    @if ($toko->bio_toko)
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control" id="exampleFormControlTextarea1" rows="10" name="bio_toko" required>{{ $toko->bio_toko }}</textarea>
                                        </div>
                                    @else
                                        <div class="mb-3">
                                            <label for="exampleFormControlTextarea1" class="form-label">Bio Toko</label>
                                            <textarea class="form-control" rows="5" name="bio_toko" required></textarea>
