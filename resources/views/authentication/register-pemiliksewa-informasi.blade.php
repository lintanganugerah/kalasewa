                        ...
                        <form action="{{ route('registerInformationActionPemilikSewa') }}" method="POST"
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="text" id="NIK" class="form-control form-control-lg error-check"
                                    ...
                                    value="{{ old('nomor_identitas') }}" required @error('nomor_identitas')
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="text" id="namaToko" class="form-control form-control-lg error-check"
                                    name="namaToko" value="{{ old('namaToko') }}" required @error('namaToko')
                                    style="border-color:#D44E4E" @enderror />
                                @error('namaToko')
                            ...
                            <div class="form-outline mb-4">
                                <label class="form-label" for="nomor_telpon">Nomor Telpon Toko<span
                                        class="text-danger">*</span></label>
                                <input type="text" id="nomor_telpon" class="form-control form-control-lg error-check"
                                    name="nomor_telpon" pattern="[0-9]*" minlength="10" maxlength="13"
                                    value="{{ old('nomor_telpon') }}" required @error('nomor_telpon')
                                    style="border-color:#D44E4E" @enderror />
                            ...
                            <div class="form-outline mb-4">
                                <label class="form-label" for="form2Example27">Alamat Toko<span
                                        class="text-danger">*</span></label>
                                <textarea type="text" id="alamat" class="form-control form-control-lg error-check"
                                    name="AlamatToko" required @error('AlamatToko') style="border-color:#D44E4E"
                            ...
                            <div class="form-floating mb-4">
                                <select class="form-select error-check" id="provinsi" name="provinsi"
                                    aria-label="Floating label select example" required @error('provinsi')
                                    style="border-color:#D44E4E" @enderror>
                                    <option selected> </option>
                                    <option value="Jawa Barat" {{ old('provinsi') == 'Jawa Barat' ? 'selected' : '' }}>
                                        Jawa Barat
                                    </option>
                                </select>
                            ...
                            <div class="form-floating mb-4">
                                <select class="form-select error-check" id="kota" name="kota"
                                    aria-label="Floating label select example" required @error('kota')
                                    style="border-color:#D44E4E" @enderror>
                                    <option selected> </option>
                                    <option value="Kota Bandung" {{ old('kota') == 'Kota Bandung' ? 'selected' : '' }}>
                                        Kota Bandung</option>
                                    <option value="Kabupaten Bandung" {{ old('kota') == 'Kabupaten Bandung' ? 'selected' : '' }}>Kabupaten
                                        Bandung
                                    </option>
                                </select>
                            ...
                            <div class="d-grid mb-5">
                                <div class="form-outline">
                                    <label class="form-label" for="kodePos">Kode Pos<span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="kodePos" class="form-control error-check" name="kodePos"
                                        pattern="[0-9]*" minlength="5" maxlength="5" value="{{ old('kodePos') }}"
                                        required @error('kodePos') style="border-color:#D44E4E" @enderror />
                                </div>
