                        ...
                        <div class="card-body p-4 p-lg-5 text-black">
                            ...
                            <form action="{{ route('registerInformationActionPemilikSewa') }}" method="POST"
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <div id="HELP" class="form-text">Minimal 8 karakter
                                    </div>
                                </div>
                                ...
                                <div class="form-outline mb-4">
                                    <label class="form-label" for="form2Example17">Nomor Identitas (NIK)<span
                                            class="text-danger">*</span></label>
                                ...
                                <div class="form-outline mb-4">
                                    <label class="form-label" for="form2Example17">Nama Toko<span
                                            class="text-danger">*</span></label>
