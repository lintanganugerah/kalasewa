                        ...
                        <form action="{{ route('registerInformationActionPenyewa') }}" method="POST"
                            ...
                            <div class="form-outline mb-4">
                                <label for="validpassword" class="form-label">Konfirmasi Password<span
                                        class="text-danger">*</span></label>
                                <div class="input-group">
                                    <input type="Password" class="form-control" id="password_confirmation" name="confPassword"
                                        minlength="8" required>
                                    <button type="button" class="btn btn-outline-secondary" id="toggle-password"
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <div id="HELPER" class="form-text">Nomor Identitas harus sesuai dengan yang ada di KTP!
                                </div>
                            </div>
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <select class="form-select form-select-lg" id="ket_no_darurat" name="ket_no_darurat"
                                    ...
                                    <option value="{{ $option }}"
                                        {{ old('ket_no_darurat') == $option ? 'selected' : '' }}>{{ $option }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="d-grid mb-5">
                                <div class="form-outline">
                                    <label class="form-label" for="kodePos">Kode Pos<span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="kodePos" class="form-control form-control-lg" name="kodePos"
                                        pattern="[0-9]*" minlength="5" maxlength="6" value="{{ old('kodePos') }}"
                                        required />
                                </div>
                                <div id="provinsi" class="form-text">Mohon maaf saat ini kami hanya melayani wilayah
                                    bandung saja</div>
