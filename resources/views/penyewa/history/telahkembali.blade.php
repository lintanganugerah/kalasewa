                ...
                <div class="card">
                    <div class="card-header">
                        <ul class="nav nav-tabs card-header-tabs" id="historyTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-secondary"
                                    href="{{route('viewHistorySedangBerlangsung')}}">Sedang Digunakan
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page"
                                    href="{{route('viewHistoryTelahKembali')}}">Dikirim
                            ...
                            <table class="table" id="table-history">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>@if ($order->status == "Telah Kembali")
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <img src="{{ asset($order->bukti_resi_pengembalian) }}" alt="Resi"
