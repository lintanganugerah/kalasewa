                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs" id="historyTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-secondary" href="{{ route('viewHistoryMenungguDiproses') }}">Sedang
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="{{ route('viewHistoryPenyewaanSelesai') }}">Penyewaan
                                        Selesai</a>
                                </li>
                            </ul>
                        </div>
                                            ...
                                            @foreach ($orders as $order)
                                                @if ($order->status == 'Penyewaan Selesai' or $order->status == 'Retur Selesai')
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-danger w-100" href="{{ route('viewPenyewaanSelesai', ['orderId' => $order->nomor_order]) }}">Detail</a>
