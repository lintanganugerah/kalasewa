        ...
        <div class="container-fluid">
            <div class="container">
                ...
                <a href="{{route('viewHistoryOngoing')}}" class="no-underline">
                    <button type="button" class="btn btn-danger">Sedang
                        Berlangsung</button>
                </a>
                <a href="{{route('viewHistoryFinish')}}" class="no-underline">
                    <button type="button" class="btn btn-outline-danger">Selesai</button>
                </a>
            </div>
        </div>
    </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($order->additional)
                                @php
                                $additionalData = is_array($order->additional) ? $order->additional :
