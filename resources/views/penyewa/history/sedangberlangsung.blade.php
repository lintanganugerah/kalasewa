                            ...
                            <table class="table w-100" id="table-history">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>@if ($order->status == "Sedang Berlangsung")
                                            Sedang Digunakan
                                            @endif</ td>
                                        <td>
                                    ...
                                    <div class="modal fade" id="returModal-{{ $loop->iteration }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5" id="exampleModalLabel">Retur Barang
                                                    </h1>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="alamat-pengembalian" style="margin-top: -20px;">
                                                            <label for="exampleInputEmail1" class="form-label">Alamat
                                                                Pengembalian</label>
                                                            <textarea name="alamatpengembalian"
                                                                placeholder="Alamat Pengembalian Produk"
                                                            ...
                                                            <div id="emailHelp" class="form-text">Silahkan lakukan
                                                                pengiriman kembali ke alamat yang tertera!</div>
                                                        </div>
                                                        <div class="nomor-resi mt-2">
                                                            ...
                                                            <input type="text" name="nomor_resi"
                                                                ...
                                                                class="form-control form-control-lg w-100" />
                                                            <div id="emailHelp" class="form-text">Nomor resi pengiriman
                                                                untuk pelacakan</div>
                                                        </div>
                                                        <div class="bukti-resi mt-2">
                                                            <label for="formFile" class="form-label">Bukti Resi /
                                                                Pengiriman<span class="text-danger">*</span></label>
                                                            <input class="form-control" type="file" id="formFile"
                                                                name="bukti_resi_penyewa" accept=".jpg,.png,.jpeg,.webp"
                                                                required>
                                                            <div id="emailHelp" class="form-text">Silahkan berikan bukti
                                                                gambar resi atau screenshot pengiriman barang!</div>
                                                        </div>
                                                        ...
                                                        <div class="ulasan-kostum mt-2">
                                                            ...
                                                            <textarea name="ulasankostum"
                                                                placeholder="Ulasan Kostum yang Dirental"
                                                                class="form-control form-control-lg w-100"
                                                                required></textarea>
                                                            <div id="emailHelp" class="form-text">Silahkan tuliskan
                                                                ulasan anda terhadap kostum yang anda rental!</div>
                                                        </div>
                                                        <div class="dokumentasi-kostum mt-2">
                                                            <label for="formFile" class="form-label">Tambahkan
                                                                Foto</label>
                                                            <input class="form-control" type="file" id="formFile"
                                                                name="dokumentasi_kostum[]" accept=".jpg,.png,.jpeg"
                                                                multiple>
                                                            <div id="imageContainer"></div>
                                                            <div id="emailHelp" class="form-text">Gambar bisa lebih dari
                                                                1</div>
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
