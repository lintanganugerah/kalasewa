                ...
                <div class="col-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h4><strong id="total-tagihan">Rp{{ number_format($order->total_tagihan, 0, '', '.')
                                    }}</strong>
                            </h4>
                        </div>
                    ...
                    <div class="choice-cntr mt-2">
                        <a class="btn btn-outline-danger w-100 mb-2" href="#" role="button" data-bs-toggle="modal"
                            data-bs-target="#returModal">Beri Ulasan</a>
                    </div>
