            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-3">
                        ...
                        <<<<<<< HEAD <div class="choice-cntr mt-2">
                            <a class="btn btn-outline-danger w-100 mb-2" href="#" role="button"
                                data-bs-toggle="modal" data-bs-target="#ulasanModal">Beri Ulasan</a>
                    </div>

                    =======
                    >>>>>>> origin/part-customer-iterasi3
                </div>
            </div>
        </div>
        </div>
