                        ...
                        <div class="card-body">
                            ...
                            <table class="w-100">
                                ...
                                <tr class="text-secondary">
                                    <td>Harga Katalog</td>
                                    <td id="harga-katalog" class="text-end">Rp{{ number_format($order->harga_katalog, 0, '', '.') }}</td>
                                </tr>
                                <tr class="text-secondary">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="col text-end">
                                    ...
                                    @if ($order->jaminan < 0) <p class="text-secondary">Rp0</p>
                                        @else
                                        <p class="text-secondary">
                            ...
                            @elseif ($order->jaminan < 0) <h5 class="mt-2 text-danger"><strong>Total Hutang <i
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="w-100 mb-3">
                        ...
                        @if ($order->jaminan < 0) <tr class="text-danger fw-bold">
                            <td>Hutang</td>
                            <td class="text-end">:</td>
