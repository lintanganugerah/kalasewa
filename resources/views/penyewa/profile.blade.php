                        ...
                        <div class="card-body p-4 p-lg-5 text-black">
                            ...
                            <form action="{{ route('updateProfilAction') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <div id="provinsi" class="form-text">Nama tidak dapat diganti karena disesuaikan dengan
                                        identitas
                                    </div>
                                </div>
                                ...
                                <div data-mdb-input-init class="form-outline mb-4">
                                    ...
                                    <textarea type="text" id="alamat" class="form-control form-control-lg" name="alamat" required> {{ $user->alamat }} </textarea>
                                </div>
