                                                    ...
                                                    <div class="mt-2 mb-0 text-muted text-xs">
                                                        <span class="mr-2">
                                                            @if (auth()->user()->toko->countPenyewaanAll()[2] == 'naik')
                                                                ...
                                                                <span
                                                                    class="text-success">{{ auth()->user()->toko->countPenyewaanAll()[1] }}%</span>
                                                            @elseif(auth()->user()->toko->countPenyewaanAll()[2] == 'turun')
                                                                <i class="fas fa-arrow-down text-danger"></i>
                                                                <span
                                                                    class="text-danger">{{ auth()->user()->toko->countPenyewaanAll()[1] }}%</span>
                                                            @else
                                                    ...
                                                    <div class="mt-2 mb-0 text-muted text-xs">
                                                        <span class="mr-2">
                                                            @if (auth()->user()->toko->countPenyewaanAllBerstatus('Penyewaan Selesai')[2] == 'naik')
                                                                <i class="fas fa-arrow-up text-success"></i>
                                                                <span
                                                                    class="text-success">{{ auth()->user()->toko->countPenyewaanAllBerstatus('Penyewaan Selesai')[1] }}%</span>
                                                            @elseif(auth()->user()->toko->countPenyewaanAllBerstatus('Penyewaan Selesai')[2] == 'turun')
                                                                <i class="fas fa-arrow-down text-danger"></i>
                                                                <span
                                                                    class="text-danger">{{ auth()->user()->toko->countPenyewaanAllBerstatus('Penyewaan Selesai')[1] }}%</span>
                                                            @else
                                                                <i class="fas fa-minus text-secondary"></i>
                                                                <span
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-uppercase mb-1">Penyewaan
                                                        Diretur</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                        {{ auth()->user()->toko->countPenyewaanAllBerstatus('Penyewaan Diretur')[0] }}
                                                    </div>
                                                    <div class="mt-2 mb-0 text-muted text-xs">
                                                        <span class="mr-2">
                                                            @if (auth()->user()->toko->countPenyewaanAllBerstatus('Penyewaan Diretur')[2] == 'naik')
                                                                <i class="fas fa-arrow-up text-success"></i>
                                                                <span
                                                                    class="text-success">{{ auth()->user()->toko->countPenyewaanAllBerstatus('Penyewaan Diretur')[1] }}%</span>
                                                            @elseif(auth()->user()->toko->countPenyewaanAllBerstatus('Penyewaan Diretur')[2] == 'turun')
                                                                <i class="fas fa-arrow-down text-danger"></i>
                                                                <span
                                                                    class="text-danger">{{ auth()->user()->toko->countPenyewaanAllBerstatus('Penyewaan Diretur')[1] }}%</span>
                                                            @else
                                                                <i class="fas fa-minus text-secondary"></i>
                                                                <span
                                                                    class="text-secondary">{{ auth()->user()->toko->countPenyewaanAllBerstatus('Penyewaan Diretur')[1] }}%</span>
                                                            @endif
                                                        </span>
                                                        <span>Dari bulan lalu
                                                            ({{ auth()->user()->toko->countPenyewaanAllBerstatus('Penyewaan Diretur')[3] }}
                                                            penyewaan)</span>
                                                    </div>
                                                </div>
                                                <div class="col-auto">
