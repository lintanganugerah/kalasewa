            ...
            <div class="col-md-6 d-flex align-items-center">
                <div class="d-flex align-items-center">
                    <div class="product-image-container me-3">
                        <img src="{{ asset('storage/profiles/profil_default.jpg') }}" alt="Produk"
                            class="product-image">
                    </div>
                    <div>
                        <h5 class="fw-bold">{{ $penyewa->nama }}
                            ...
                            @if (
                            number_format($penyewa->avg_nilai_penyewa($penyewa->id), 1) > 2.5 &&
                            number_format($penyewa->avg_nilai_penyewa($penyewa->id), 1) < 4 ) <span
                                class="badge text-white ms-3" style="background-color: EB7F01;">
                                Standart</span>
                                @elseif (number_format($penyewa->avg_nilai_penyewa($penyewa->id), 1) < 2.5) <span
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                {{-- <td data-title="Produk" class="align-middle">
                                                            <a class=" cut-text"
                                                                href="{{ route('viewDetail', ['id' => $review->id_review_produk->id]) }}">{{
                                                                $review->id_review_produk->nama_produk }}
                                                </a>
                                                </td> --}}
                                                ...
                                                <td data-title="Aksi" class="align-middle">
                                                    <button data-bs-toggle="modal"
                                                        ...
                                                        class="btn btn-outline" id="proses" style="color:#CE2525">Lihat
                                                        Foto Review</button>
                                                </td>
                                            </tr>

                                            <!-- Modal -->
                                            <div class="modal fade" id="modal-foto-{{ $review->id }}" tabindex="-1"
                                                aria-labelledby="modal-foto-{{ $review->id }}Label" aria-hidden="true">
