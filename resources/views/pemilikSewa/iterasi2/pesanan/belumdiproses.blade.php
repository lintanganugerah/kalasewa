                    ...
                    <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-secondary" id="tambahProduk-tab"
                                onclick="window.location.href='/status-sewa/dalampengiriman'" type="button" role="tab"
                                aria-controls="tambahProduk" aria-selected="false">Dalam
                                Pengiriman</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-secondary" id="tambahProduk-tab"
                                onclick="window.location.href='/status-sewa/sedangberlangsung'" type="button" role="tab"
                                aria-controls="tambahProduk" aria-selected="false">Sedang
                                Berlangsung</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-secondary" id="tambahProduk-tab"
                        ...
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-secondary" id="tambahProduk-tab"
                                onclick="window.location.href='/status-sewa/penyewaandiretur'" type="button" role="tab"
                                aria-controls="tambahProduk" aria-selected="false">Penyewaan
                                diretur</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link text-secondary" id="tambahProduk-tab"
                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active mt-3" id="Informasi" role="tabpanel"
                            ...
                            <div class="text-dark rounded-3">
                                ...
                                <table id="tabel" class="no-more-tables table w-100 tabel-data align-items-center"
                                    ...
                                    <tbody>
                                        ...
                                        <!-- Modal Input Resi -->
                                        <div class="modal fade" id="inputResi-{{ $ord->nomor_order }}" tabindex="-1"
                                            aria-labelledby="inputResi-{{ $ord->nomor_order }}Label" aria-hidden="true">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="m-2">
                                                                ...
                                                                <hr class="border border-secondary opacity-50 my-4">
                                                                <label for="inputResi" class="form-label">Nomor
                                                                    Resi<span class="text-danger">*</span></label>
                                                                <input type="text" class="form-control mb-3"
                                                                    name="nomor_resi" id="inputResi" required>
                                                                <label for="inputResi" class="form-label">Foto Bukti
                                                                    Resi<span class="text-danger">*</span></label>
                                                                <input type="file" class="form-control mb-3"
                                                                    name="foto_bukti_resi" id="fotoresi"
                                                                    accept=".jpg,.png,.jpeg,.webp" required>
                                                                <label for="fotoresi" class="form-label">Ongkir<span
                                                                        class="text-danger">*</span></label>
                                                                <input type="number" class="form-control mb-3"
                                                                    name="biaya_pengiriman" id="biaya_pengiriman"
                                        ...
                                        <!-- Modal Batalkan -->
                                        <div class="modal fade" id="batalkan-{{ $ord->nomor_order }}" tabindex="-1"
                                            aria-labelledby="batalkan-{{ $ord->nomor_order }}Label" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered">
                                                <form
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="m-2">
                                                                ...
                                                                <small class="fw-light mb-3" href=""
                                                                    ...
                                                                    {{ $ord->id_produk_order->ukuran_produk }}</small>
                                                                <hr class="border border-secondary opacity-50 my-4">
                                                                <label for="alasan_batal" class="form-label">Alasan
                                                                    Pembatalan</label>
                                                                <textarea type="text" class="form-control"
                                                                    name="alasan_batal" id="alasan_batal"
                                                                    required> </textarea>
                                                            </div>
                                                            ...
                                                            <p class="m-2 mt-2">Jika produk telah anda
                                                                batalkan, status produk akan menjadi "arsip".
                            ...
                            {{-- Modal Peringatan --}}
                            <div class="modal" id="modal_auto" tabindex="-1" aria-labelledby="exampleModalCenterTitle"
