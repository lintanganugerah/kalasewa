                                        ...
                                        @if ($order)
                                            ...
                                            <tbody>
                                                @foreach ($order as $ord)
                                                    ...
                                                    <!-- Modal bukti resi -->
                                                    <div class="modal fade" id="buktiResi-{{ $ord->nomor_order }}" tabindex="-1"
                                                        aria-labelledby="resiModalLabel-{{ $ord->nomor_order }}" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h1 class="modal-title fs-5" id="resiModalLabel-{{ $ord->nomor_order }}">
                                                                        Bukti
                                                                        Resi Pengembalian</h1>
                                                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                                                </div>
                                                                <div class="modal-body">
                                                                    <p>Nomor Resi: <strong>{{ $ord->nomor_resi }}</strong></p>
                                                                    <img src="{{ asset($ord->bukti_resi_pengembalian) }}" alt="Resi" class="rounded img-fluid mt-3">
                                                                </div>
                                                                <div class="modal-footer">
