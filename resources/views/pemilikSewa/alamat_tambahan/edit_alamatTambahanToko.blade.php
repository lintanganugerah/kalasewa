                            ...
                            <div class="tab-pane fade show active" id="profil" role="tabpanel"
                                ...
                                <form action="{{ route('seller.profil.EditAlamatTambahanAction', $at->id) }}" method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control error-check" name="kodePosTambahan"
                                            pattern="[0-9]*" id="kodePos" minlength="5"
                                            @error('kodePosTambahan') style="border-color: red;" @enderror maxlength="5"
                                            value="{{ old('kodePosTambahan', $at->kode_pos) }}" required>
                                    ...
                                    <div class="mb-3">
                                        <label for="kotaTambahan" class="form-label">Kota/Kabupaten<span
                                                class="text-danger">*</span></label>
                                        <select class="form-select error-check" id="floatingSelect" name="kotaTambahan"
