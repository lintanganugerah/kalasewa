                            ...
                            <form action="{{ route('seller.tambahProdukAction') }}" id="formproduk" method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="10"
                                        name="deskripsiProduk" required></textarea>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="form-floating mb-3">
                                    <select class="form-select select2" id="selectSeries" name="series" required>
                                        <option value="" disabled selected>Pilih atau ketik untuk menambahkan series
                                            baru</option>
                                        @foreach ($series as $sr)
                                        <option value="{{ $sr->series }}">{{ $sr->series }}</option>
                                        @endforeach
                                    </select>
...
$(document).ready(function() {
    $('#selectSeries').select2({
        tags: true,
        placeholder: "Pilih atau ketik untuk menambahkan series baru",
        allowClear: true,
