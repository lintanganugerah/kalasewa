<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo e(route('admin.dashboard')); ?>">
        <div class="sidebar-brand-icon">
            <img src="<?php echo e(asset('admincss/img/logo/Logo_Kalasewa.png')); ?>">
        </div>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(route('admin.dashboard')); ?>" data-toggle="collapse"
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(route('admin.series.index')); ?>" data-toggle="collapse"
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(route('admin.users.index')); ?>" data-toggle="collapse"
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(route('admin.verify.index')); ?>" data-toggle="collapse"
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(route('admin.banks.index')); ?>" data-toggle="collapse"
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(route('admin.refunds.index')); ?>" data-toggle="collapse"
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(route('admin.ticket.index')); ?>" data-toggle="collapse"
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(route('admin.retur.index')); ?>" data-toggle="collapse"
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(route('admin.penalty.index')); ?>" data-toggle="collapse"
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="<?php echo e(route('admin.aboutus.index')); ?>" data-toggle="collapse"
...
<script>
    ...
    document.getElementById('manajemenSeries').addEventListener('click', function (event) {
        ...
        window.location.href = '<?php echo e(route('admin.series.index')); ?>';
    });
    ...
    document.getElementById('verifikasiUser').addEventListener('click', function (event) {
        event.preventDefault();
        window.location.href = '<?php echo e(route('admin.verify.index')); ?>';
    });

    document.getElementById('rekeningTujuan').addEventListener('click', function (event) {
        event.preventDefault();
        window.location.href = '<?php echo e(route('admin.banks.index')); ?>';
    });

    document.getElementById('refund').addEventListener('click', function (event) {
        event.preventDefault();
        window.location.href = '<?php echo e(route('admin.refunds.index')); ?>';
    });

    document.getElementById('ticket').addEventListener('click', function (event) {
        event.preventDefault();
        window.location.href = '<?php echo e(route('admin.ticket.index')); ?>';
    });

    document.getElementById('retur').addEventListener('click', function (event) {
        event.preventDefault();
        window.location.href = '<?php echo e(route('admin.retur.index')); ?>';
    });

    document.getElementById('penalty').addEventListener('click', function (event) {
        event.preventDefault();
        window.location.href = '<?php echo e(route('admin.penalty.index')); ?>';
    });

    document.getElementById('peraturanPlatform').addEventListener('click', function (event) {
        event.preventDefault();
        window.location.href = '<?php echo e(route('admin.regulations.index')); ?>';
    });

    document.getElementById('tentangKalasewa').addEventListener('click', function (event) {
        event.preventDefault();
        window.location.href = '<?php echo e(route('admin.aboutus.index')); ?>';
    });
</script><?php /**PATH E:\Backup data c\kuliah\Semester 8\Tugas Akhir\WEBSITE\Development\Iterasi 3\kalasewa hosting iterasi 3 v1\resources\views/admin/partials/sidebar.blade.php ENDPATH**/ ?>