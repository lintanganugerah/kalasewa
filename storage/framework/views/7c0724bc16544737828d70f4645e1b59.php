                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <h5 class="info-keuangan">
                                Rp. <?php echo e(number_format(auth()->user()->toko->saldo_tertunda(), 0, ',', '.')); ?>
                        ...
                        <div class="col">
                            ...
                            <h5 class="info-keuangan">
                                Rp.
                                <?php echo e(number_format(auth()->user()->saldo_user->saldo ?? '0', 0, ',', '.')); ?>
                ...
                <div class="card-body">
                    <table class="table no-more-tables tabel-data" id="series-table">
                        ...
                        <tbody id="series-table">
                            <?php $__currentLoopData = $data_penarikan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $penarikan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td data-title="Tanggal" class="align-middle">
                                        <?php echo e($penarikan->created_at->translatedFormat('d/m/Y')); ?></td>
                                    <td data-title="Jumlah" class="align-middle">Rp.
                                        <?php echo e(number_format($penarikan->nominal, 0, ',', '.')); ?></td>
                                    <td data-title="Rekening" class="align-middle"><?php echo e($penarikan->nomor_rekening); ?></td>
                                    <td data-title="Atas Nama Rek." class="align-middle"><?php echo e($penarikan->nama_rekening); ?>

                                    </td>
                                    <td data-title="Tujuan" class="align-middle"><?php echo e($penarikan->bank); ?></td>
                                    <td data-title="Status" class="align-middle"><?php echo e($penarikan->status); ?>

                                        <?php if($penarikan->status == 'Ditolak'): ?>
                                            karena <?php echo e($penarikan->alasan_penolakan); ?>

                                        <?php elseif($penarikan->status == 'Selesai'): ?>
                                            <br><a href="<?php echo e(asset($penarikan->bukti_transfer)); ?>" target="_blank">Lihat
                                                Bukti
                                                Transfer</a>
                                        <?php endif; ?>
                                    </td>
...
<?php echo $__env->make('layout.selllayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Backup data c\kuliah\Semester 8\Tugas Akhir\WEBSITE\Revisi\revisi kalasewa v2\resources\views/pemilikSewa/iterasi3/keuangan/viewRiwayatPenarikan.blade.php ENDPATH**/ ?>