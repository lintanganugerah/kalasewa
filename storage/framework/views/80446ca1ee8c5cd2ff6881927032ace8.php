...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.verify.index')); ?>">Verifikasi User</a></li>
...
<div class="row">
            ...
            <div class="card-body">
                <ul class="list-group list-group-flush">
                    <li class="list-group-item d-flex" style="padding: 10px 20px;">
                        ...
                        <span style="flex: 2;"> <?php echo e($user->NIK); ?></span>
                    </li>
                    <li class="list-group-item d-flex" style="padding: 10px 20px;">
                        <strong style="flex: 1;">Nama</strong>
                        <span style="flex: 0 0 auto;">: </span>
                        <span style="flex: 2;"> <?php echo e($user->nama); ?></span>
                    </li>
                    <li class="list-group-item d-flex" style="padding: 10px 20px;">
                        <strong style="flex: 1;">Email</strong>
                        <span style="flex: 0 0 auto;">: </span>
                        <span style="flex: 2;"> <?php echo e($user->email); ?></span>
                    </li>
                    <li class="list-group-item d-flex" style="padding: 10px 20px;">
                        <strong style="flex: 1;">Nomor Telepon</strong>
                        <span style="flex: 0 0 auto;">: </span>
                        <span style="flex: 2;"> <?php echo e($user->no_telp); ?></span>
                    </li>
                    <li class="list-group-item d-flex" style="padding: 10px 20px;">
                        <strong style="flex: 1;">Nomor Telepon Darurat</strong>
                        <span style="flex: 0 0 auto;">: </span>
                        <span style="flex: 2;"> <?php echo e($user->no_darurat); ?> (<?php echo e($user->ket_no_darurat); ?>)</span>
                    </li>
                    <li class="list-group-item d-flex" style="padding: 10px 20px;">
                        <strong style="flex: 1;">Alamat</strong>
                        <span style="flex: 0 0 auto;">: </span>
                        <span style="flex: 2;"> <?php echo e($user->alamat); ?></span>
                    </li>
                    <li class="list-group-item d-flex" style="padding: 10px 20px;">
                        <strong style="flex: 1;">Kode Pos</strong>
                        <span style="flex: 0 0 auto;">: </span>
                        <span style="flex: 2;"> <?php echo e($user->kode_pos); ?></span>
                    </li>
                    <li class="list-group-item d-flex" style="padding: 10px 20px;">
                        <strong style="flex: 1;">Kota/Kabupaten</strong>
                        <span style="flex: 0 0 auto;">: </span>
                        <span style="flex: 2;"> <?php echo e($user->kota); ?>, <?php echo e($user->provinsi); ?></span>
                    </li>
                    <li class="list-group-item d-flex" style="padding: 10px 20px;">
                        <strong style="flex: 1;">Role</strong>
                        <span style="flex: 0 0 auto;">: </span>
                        <span style="flex: 2;"> <?php echo e($user->role === 'penyewa' ? 'Penyewa' : 'Pemilik Sewa'); ?></span>
                    </li>
                    <li class="list-group-item d-flex" style="padding: 10px 20px;">
                        <strong style="flex: 1;">Link Instagram</strong>
                        <span style="flex: 0 0 auto;">: </span>
                        <span style="flex: 2;"><a href="<?php echo e($user->link_sosial_media); ?>" target="_blank">
                                <?php echo e($user->link_sosial_media); ?></a></span>
                    </li>
                </ul>
                <div class="mt-4 d-flex justify-content-between">
                    <button type="button" class="btn btn-success" style="width: 45%;"
                        onclick="confirmAction('<?php echo e(route('admin.users.updateVerification', $user->id)); ?>', 'verify')">Verifikasi</button>
                    <button type="button" class="btn btn-danger" style="width: 45%;"
                        onclick="confirmAction('<?php echo e(route('admin.users.updateVerification', $user->id)); ?>', 'reject')">Tolak</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-md-6">
        <?php if($user->role !== 'pemilik_sewa'): ?>
            <div class="text-center mb-4">
                <img id="userFotoProfil"
                    src="<?php echo e($user->foto_profil ? asset($user->foto_diri) : asset('default-profile.png')); ?>"
                    alt="Foto Profil" class="img-thumbnail" style="max-width: 150px;">
            </div>
        <?php endif; ?>
        <div class="text-center mt-4">
            <img id="userIdentitas" src="<?php echo e($user->foto_identitas ? asset($user->foto_identitas) : 'FOTO NULL'); ?>"
...
<?php echo $__env->make('admin.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kalasewa/kalasewa/resources/views/admin/verify/detail.blade.php ENDPATH**/ ?>