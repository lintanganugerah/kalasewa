                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            <li class="nav-item" role="presentation">
                                <a class="nav-link fw-bold active" id="penyewa-tab" href="<?php echo e(route('registerViewPenyewa')); ?>"
                                    role="tab" aria-controls="penyewa" aria-selected="false">Penyewa</a>
                            </li>
                            <li class="nav-item" role="presentation">
                                <a class="nav-link text-secondary" id="pemilik-sewa-tab" href="<?php echo e(route('registerViewPemilikSewa')); ?>"
                        ...
                        <div class="tab-pane show active" id="penyewa" role="tabpanel" aria-labelledby="penyewa-tab">
                            ...
                            <div class="card">
                                <div class="card-body py-5 px-md-5">
                                    ...
                                    <form id="formRegister" action="<?php echo e(route('checkEmailPenyewa')); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout.layout-seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kalasewa/kalasewa/resources/views/authentication/register-penyewa.blade.php ENDPATH**/ ?>