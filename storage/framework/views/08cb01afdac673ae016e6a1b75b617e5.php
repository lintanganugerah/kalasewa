...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('img/kalasewa_logo.png')); ?>" />
    ...
    <link type="text/css" href="<?php echo e(asset('seller/seller.css')); ?>" rel="stylesheet">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <?php echo $__env->make('layout.sellsidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH E:\Backup data c\kuliah\Semester 8\Tugas Akhir\WEBSITE\Development\Iterasi 3\Iterasi 3 kalasewa hosting v2\resources\views/layout/selllayout.blade.php ENDPATH**/ ?>