            ...
            <div class="container">
                <div class="row">
                    <div class="col-3">
                        ...
                        <img src="<?php echo e(asset($order->produk->getFotoProdukFirst($order->produk->id)->path)); ?>" class="img-thumbnail" alt="fotoproduk">
                    ...
                    <div class="col-6">
                        ...
                        <form action="">
                            ...
                            <h1><strong><?php echo e($nama_produk); ?></strong></h1>
                            ...
                            <div class="datepckr d-flex mt-3">
                                <div class="col mx-1">
                                    ...
                                    <input type="text" name="infomulai" placeholder="Tanggal Mulai Sewa" class="form-control form-control-lg w-100"
                                        value="<?php echo e($order->tanggal_mulai); ?>" readonly />
                                ...
                                <div class="col mx-1">
                                    ...
                                    <input type="text" name="infoselesai" placeholder="Tanggal Akhir Sewa" class="form-control form-control-lg w-100"
                                        value="<?php echo e($order->tanggal_selesai); ?>" readonly />
                            ...
                            <div class="namapenyewa-ctner mt-3">
                                ...
                                <input type="text" name="nama" placeholder="Nama Penyewa" class="form-control form-control-lg w-100" value="<?php echo e($nama_penyewa); ?>" readonly />
                            ...
                            <div class="metodekirim-ctner mt-3">
                                ...
                                <input type="text" name="metodekirim" placeholder="Metode Kirim" class="form-control form-control-lg w-100" value="<?php echo e($order->metode_kirim); ?>"
                                    readonly />
                            ...
                            <div class="noresi-ctner mt-3">
                                ...
                                <input type="text" name="nomorresi" placeholder="Nomor Resi" class="form-control form-control-lg w-100" value="<?php echo e($order->nomor_resi); ?>" readonly />
                            ...
                            <div class="card-body">
                                ...
                                <table class="w-100">
                                    ...
                                    <tr class="text-secondary">
                                        <td>Harga Katalog</td>
                                        <td id="harga-katalog" class="text-end">Rp<?php echo e(number_format($harga_katalog, 0, '', '.')); ?></td>
                                    </tr>
                                    <tr class="text-secondary">
                                ...
                                <table class="w-100">
                                    ...
                                    <tr class="text-secondary">
                                        ...
                                        <?php if($order->jaminan < 0): ?>
                                            <td id="jaminan-kostum" class="text-end">Rp<?php echo e(number_format(0)); ?></td>
                                        <?php else: ?>
...
<!-- 
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="col text-end">
                                        <p class="text-secondary" id="harga-katalog">
                                            Rp<?php echo e(number_format($harga_katalog, 0, '', '.')); ?></p>
                                ...
                                <h5 class="mt-2"><strong>Total Tagihan</strong></h5>
                                <h4><strong id="total-tagihan">Rp<?php echo e(number_format($order->grand_total, 0, '', '.')); ?></strong>
                                </h4>
                                ...
                                <?php elseif($order->jaminan < 0): ?>
                                    ...
                                    <h4 class="text-danger"><strong id="total-tagihan">Rp<?php echo e(number_format(abs($order->jaminan), 0, '', '.')); ?></strong>
                                    </h4>
                                <?php endif; ?>
                    ...
                    <div class="modal-body">
                        <table class="w-100 mb-3">
                            ...
                            <tr class="text-danger">
                                ...
                                <td class="text-end">:</td>
                                <td class="text-end">Rp<?php echo e(number_format($denda_lain ?? 0, 0, '', '.')); ?>
    ...
    <script type="text/javascript">
        document.getElementById('pay-button').onclick = function() {
            $.ajax({
                url: '<?php echo e(route('createSnapTokenDenda', $order->nomor_order)); ?>',
                type: 'POST',
                data: {
                    ...
                    if (response.success) {
                        ...
                        snap.pay(response.snap, {
                            onSuccess: function(result) {
                                $.ajax({
                                    url: '<?php echo e(route('updatePenghasilan', $order->nomor_order)); ?>',
                                    type: 'POST',
                                    data: {
                                        _token: '<?php echo e(csrf_token()); ?>',
                                    },
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kalasewa/kalasewa/resources/views/penyewa/transaksi/detailPengembalian.blade.php ENDPATH**/ ?>