                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="profil" role="tabpanel"
                            ...
                            <?php endif; ?>
                            <form action="<?php echo e(route('seller.profilTokoAction')); ?>" method="POST" id="formToko"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex align-items-start">
                                        <div id="userPhotoContainer" class="me-3">
                                            <img id="userPhotoPreview" src="<?php echo e(asset(session('profilpath'))); ?>"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="exampleFormControlInput1"
                                        value="<?php echo e(session('namatoko')); ?>" name="namaToko" required>
                                </div>
                                <?php if($toko->bio_toko): ?>
                                    <div class="mb-3">
                                        <label for="exampleFormControlTextarea1" class="form-label">Bio Toko</label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="10" name="bio_toko"><?php echo e($toko->bio_toko); ?></textarea>
                                    </div>
                                <?php else: ?>
                                    <div class="mb-3">
                                        <label for="exampleFormControlTextarea1" class="form-label">Bio Toko</label>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="form2Example17" class="form-control"
                                        value="<?php echo e($user->link_sosial_media); ?>" name="link_sosial_media" required />
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label">Nomor Telpon<span
                                            class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="nomor_telpon"
                                        value="<?php echo e($user->no_telp); ?>" name="nomor_telpon"minlength="10" maxlength="14"
                                        required>
                                </div>
                                <div class="mb-3">
                                    <label for="exampleFormControlTextarea1" class="form-label">Alamat Utama Toko<span
                                            class="text-danger">*</span></label>
                                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="5" name="AlamatToko" required><?php echo e($user->alamat); ?></textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="provinsiSelect" name="provinsi"
                                        ...
                                        <option value="Jawa Barat"
                                            <?php echo e($user->kota == 'Jawa Barat' ? 'selected' : ''); ?>>
                                            Jawa Barat</option>
                                    </select>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="kotaSelect" name="kota"
                                        ...
                                        <option value="Kota Bandung"
                                            <?php echo e($user->kota == 'Kota Bandung' ? 'selected' : ''); ?>>Kota Bandung</option>
                                        <option value="Kabupaten Bandung"
                                            <?php echo e($user->kota == 'Kabupaten Bandung' ? 'selected' : ''); ?>>Kabupaten
                                            Bandung
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    <div data-mdb-input-init class="form-outline">
                                        <label class="form-label" for="kodePos">Kode Pos<span
                                                class="text-danger">*</span></label>
                                        <select class="form-select select2" id="kodePos" name="kodePos" data-kodePos="<?php echo e($user->kode_pos ?? 0); ?>" required>
                                        </select>
                                ...
                                <div id="helpberat" class="mb-3" style="opacity: 75%;">Jika produk/kostum anda
                                    ...
                                    anda bisa memilih lokasi produk/kostum anda berada di alamat yang mana. <a
                                        ...
                                        href="<?php echo e(route('seller.profil.viewAlamatTambahanToko')); ?>">Klik disini untuk
                                        tambah alamat</a></div>
                                <hr class="border border-secondary border-3 my-5">
...
<?php echo $__env->make('layout.selllayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Backup data c\kuliah\Semester 8\Tugas Akhir\WEBSITE\Development\Iterasi 3\Iterasi 3 kalasewa hosting v2\resources\views/profiltoko.blade.php ENDPATH**/ ?>