<?php $__env->startSection('content'); ?>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col align-self-center">
                            <a href="<?php echo e(route('seller.penarikan.viewTarikSaldo')); ?>" class="btn btn-danger m-2">Tarik
                                Saldo</a>
                            <a href="#" class="btn btn-danger m-2" data-bs-toggle="modal"
                                data-bs-target="#unduhLaporanModal">
                                Laporan
                            </a>
                        </div>
                    </div>
    ...
    <div class="row mt-4">
        <div class="col-md-12">
            <div class="row">
                <div class="col">
                    <div>
                        <h2>Penghasilan Perhari</h2>
                        <canvas id="dailyIncomeChart" height="100px"></canvas>
                    </div>

                    <script id="dailyIncomeData" type="application/json"><?php echo json_encode($dailyIncome, 15, 512) ?></script>
                    
                </div>
                <div class="col">
                    <div>
                        <h2>Penghasilan Perbulan</h2>
                        <canvas id="monthlyIncomeChart" height="100px"></canvas>
                    </div>
                    <script id="monthlyIncomeData" type="application/json"><?php echo json_encode($monthlyIncome, 15, 512) ?></script>
                </div>
                <div class="col">
                    <div>
                        <h2>Penghasilan Pertahun</h2>
                        <canvas id="yearlyIncomeChart" height="100px"></canvas>
                    </div>
                    <script id="yearlyIncomeData" type="application/json"><?php echo json_encode($yearlyIncome, 15, 512) ?></script>
                </div>
            </div>
        </div>
    </div>
                                        ...
                                        <td data-title="Total Penghasilan" class="align-middle">
                                            <?php if(
                                                ...
                                                <p><a onclick="toggleModal()" class="text-danger  btnDetailPenghasilan"
                                                        ...
                                                        data-totalpenghasilan="<?php echo e($ord->total_penghasilan); ?>">Lihat
                                                        Detail
                                                        Penghasilan</a></p>
    ...
    <!-- Modal Laporan -->
    <div class="modal fade" id="unduhLaporanModal" tabindex="-1" aria-labelledby="unduhLaporanModalLabel"
        aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?php echo e(route('export_pdf')); ?>" method="GET">
                    <div class="modal-header">
                        <h5 class="modal-title" id="unduhLaporanModalLabel">Pilih Tahun dan Bulan</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="selectedYear" class="form-label">Tahun</label>
                            <select class="form-select" id="selectedYear" name="selectedYear">
                            ...
                            <select class="form-select" id="selectedMonth" name="selectedMonth">
                                ...
                                <?php for($m = 1; $m <= 12; $m++): ?>
                                    <option value="<?php echo e($m); ?>">
                                        <?php echo e(\Carbon\Carbon::create()->month($m)->translatedFormat('F')); ?></option>
                                <?php endfor; ?>
                            </select>
                        </div>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-danger">Unduh Laporan</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <!-- Mengimpor file JavaScript dari public/js -->
    <script src="<?php echo e(asset('seller/chartKeuangan.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layout.selllayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Backup data c\kuliah\Semester 8\Tugas Akhir\WEBSITE\Revisi\revisi kalasewa v2\resources\views/pemilikSewa/iterasi3/keuangan/dashboardKeuangan.blade.php ENDPATH**/ ?>