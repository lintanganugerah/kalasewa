            ...
            <div class="row">
                <div class="d-md-block align-items-center">
                    <div class="card-body p-4 p-lg-5 text-black">
                        ...
                        <form action="<?php echo e(route('updateProfilAction')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="text" id="nama" class="form-control form-control-lg"
                                    value="<?php echo e($user->nama); ?>" disabled />
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="text" id="form2Example17" class="form-control form-control-lg"
                                    value="<?php echo e($user->NIK); ?>" disabled />
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="text" id="nomor_telpon" class="form-control form-control-lg"
                                    ...
                                    value="<?php echo e($user->no_telp); ?>" required />
                            ...
                            <div class="form-outline mb-4">
                                ...
                                <input type="text" id="nomor_telpon_darurat" class="form-control form-control-lg"
                                    ...
                                    value="<?php echo e($user->no_darurat); ?>" required />
                            ...
                            <div data-mdb-input-init class="form-outline mb-4">
                                ...
                                <textarea type="text" id="alamat" class="form-control form-control-lg" name="alamat"
                                    required> <?php echo e($user->alamat); ?> </textarea>
                            ...
                            <div class="form-floating mb-4">
                                <select class="form-select" id="floatingSelect" name="provinsi"
                                    ...
                                    <option selected> <?php echo e($user->provinsi); ?> </option>
                            ...
                            <div class="form-floating mb-4">
                                <select class="form-select" id="floatingSelect" name="kota"
                                    aria-label="Floating label select example" required>
                                    <option selected> <?php echo e($user->kota); ?> </option>
                            ...
                            <div class="d-grid mb-5">
                                <div class="form-outline">
                                    ...
                                    <input type="text" id="kodePos" class="form-control" name="kodePos" pattern="[0-9]*"
                                        minlength="5" maxlength="6" value="<?php echo e($user->kode_pos); ?>" required />
                                </div>
                                <div id="provinsi" class="form-text">Mohon maaf saat ini kami hanya melayani wilayah
                                    bandung saja</div>
                            </div>
...
<?php echo $__env->make('layout.layout-seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kalasewa/kalasewa/resources/views/penyewa/profile.blade.php ENDPATH**/ ?>