<?php $__env->startSection('content'); ?>
    ...
    <section>
        ...
        <div class="container-fluid mt-5">
            <div class="container">
                <form action="<?php echo e(route('createOrder', ['id' => $produk->id])); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-3">

                            <?php $__currentLoopData = $fotoproduk->where('id_produk', $produk->id)->take(1); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $foto): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <img src="<?php echo e(asset($foto->path)); ?>" class="img-thumbnail" alt="fotoproduk">
                        ...
                        <div class="col-6">
                            ...
                            <?php if($produk->additional): ?>
                                ...
                                <?php $__currentLoopData = json_decode($produk->additional, true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nama => $harga): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <input type="checkbox" class="btn-check additional-check"
                                        id="btn-check-additional-<?php echo e($loop->index); ?>" name="additional[]"
                                        value="<?php echo e($nama); ?>" data-nama="<?php echo e($nama); ?>"
                                        data-harga="<?php echo e($harga); ?>" autocomplete="off">
                                    <label class="btn btn-outline-dark"
                                        for="btn-check-additional-<?php echo e($loop->index); ?>"><?php echo e($nama); ?></label>
                            ...
                            <div class="sizeproduk-ctner mt-3" hidden>
                                ...
                                <input type="text" name="size" placeholder="Ukuran Produk"
                                    class="form-control form-control-lg w-100" value="<?php echo e($produk->ukuran_produk); ?>" />
                            ...
                            <div class="namapenyewa-ctner mt-3">
                                ...
                                <input type="text" name="nama" placeholder="Nama Penyewa"
                                    class="form-control form-control-lg w-100" value="<?php echo e(auth()->user()->nama); ?>"
                                    required />
                            ...
                            <div class="alamat-ctner mt-3">
                                <label for="exampleInputEmail1" class="form-label">Alamat Penyewa<span
                                        class="text-danger">*</span></label>
                                <textarea name="alamat" placeholder="Alamat Penyewa" class="form-control form-control-lg w-100" required><?php echo e(auth()->user()->alamat); ?></textarea>
                            ...
                            <div class="metodekirim-ctner mt-3">
                                ...
                                <select name="metodekirim" class="form-select" aria-label="Default select example">
                                    <?php $__currentLoopData = json_decode($produk->metode_kirim, true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ekspedisi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($ekspedisi); ?>"><?php echo e($ekspedisi); ?></option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="w-100">
                                        ...
                                        <tr class="text-secondary">
                                            <td>Harga Katalog</td>
                                            <td id="harga-katalog" class="text-end">Rp<?php echo e(number_format($produk->harga, 0, '', '.')); ?></td>
                                        </tr>
                                        <tr class="text-secondary">
                                        ...
                                        <tr class="text-secondary">
                                            ...
                                            <td id="harga-cuci" class="text-end">Rp<?php echo e(number_format($produk->biaya_cuci, 0, '', '.')); ?></td>
                                            <?php else: ?>
                                            <td id="harga-cuci" class="text-end">Rp<?php echo e(number_format(0)); ?></td>
                                            <?php endif; ?>
                                        </tr>
                                        <tr>
            ...
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <img src="<?php echo e(asset('images/bukti_ongkir.png')); ?>" alt="Input Ongkir"
                        ...
                        <img src="<?php echo e(asset('images/bukti_denda.png')); ?>" alt="Bukti denda" class="img-thumbnail w-100">
                        ...
                        <img src="<?php echo e(asset('images/bukti_ongkir_penyewa.png')); ?>" alt="Informasi Ongkir"
                            class="img-thumbnail w-100">
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Backup data c\kuliah\Semester 8\Tugas Akhir\WEBSITE\Development\Iterasi 3\kalasewa hosting iterasi 3 v1\resources\views/penyewa/pemesanan/informasiPemesanan.blade.php ENDPATH**/ ?>