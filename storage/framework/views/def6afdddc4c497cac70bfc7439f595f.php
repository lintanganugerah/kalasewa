                                        ...
                                        <?php if($order): ?>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $order; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ord): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    ...
                                                    <!-- Modal bukti resi -->
                                                    <div class="modal fade" id="buktiResi-<?php echo e($ord->nomor_order); ?>"
                                                        tabindex="-1"
                                                        aria-labelledby="resiModalLabel-<?php echo e($ord->nomor_order); ?>"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h1 class="modal-title fs-5"
                                                                        id="resiModalLabel-<?php echo e($ord->nomor_order); ?>">
                                                                        Bukti
                                                                ...
                                                                <div class="modal-body">
                                                                    <p>Nomor Resi: <strong><?php echo e($ord->nomor_resi); ?></strong>
                                                                    </p>
                                                                    <img src="<?php echo e(asset($ord->bukti_resi_pengembalian)); ?>"
...
<?php echo $__env->make('layout.selllayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Backup data c\kuliah\Semester 8\Tugas Akhir\WEBSITE\Revisi\revisi kalasewa\resources\views/pemilikSewa/iterasi2/pesanan/telahKembali.blade.php ENDPATH**/ ?>