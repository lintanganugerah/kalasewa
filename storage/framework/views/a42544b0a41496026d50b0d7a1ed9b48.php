                                                    ...
                                                    <div class="mt-2 mb-0 text-muted text-xs">
                                                        <span class="mr-2">
                                                            <?php if(auth()->user()->toko->countPenyewaanAll()[2] == 'naik'): ?>
                                                                ...
                                                                <span
                                                                    class="text-success"><?php echo e(number_format(auth()->user()->toko->countPenyewaanAll()[1], 0)); ?>%</span>
                                                            <?php elseif(auth()->user()->toko->countPenyewaanAll()[2] == 'turun'): ?>
                                                                <i class="fas fa-arrow-down text-danger"></i>
                                                                <span
                                                                    class="text-danger"><?php echo e(number_format(auth()->user()->toko->countPenyewaanAll()[1], 0)); ?>%</span>
                                                            <?php else: ?>
                                                    ...
                                                    <div class="mt-2 mb-0 text-muted text-xs">
                                                        <span class="mr-2">
                                                            <?php if(auth()->user()->toko->countPenyewaanAllBerstatus('Penyewaan Selesai')[2] == 'naik'): ?>
                                                                <i class="fas fa-arrow-up text-success"></i>
                                                                <span
                                                                    class="text-success"><?php echo e(number_format(auth()->user()->toko->countPenyewaanAllBerstatus('Penyewaan Selesai')[1], 0)); ?>%</span>
                                                            <?php elseif(auth()->user()->toko->countPenyewaanAllBerstatus('Penyewaan Selesai')[2] == 'turun'): ?>
                                                                <i class="fas fa-arrow-down text-danger"></i>
                                                                <span
                                                                    class="text-danger"><?php echo e(number_format(auth()->user()->toko->countPenyewaanAllBerstatus('Penyewaan Selesai')[1], 0)); ?>%</span>
                                                            <?php else: ?>
                                                                <i class="fas fa-minus text-secondary"></i>
                                                                <span
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-uppercase mb-1">Penyewaan
                                                        Diretur</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                        <?php echo e(auth()->user()->toko->countPenyewaanAllBerstatus('ReturAll')[0]); ?>

                                                    </div>
                                                    <div class="mt-2 mb-0 text-muted text-xs">
                                                        <span class="mr-2">
                                                            <?php if(auth()->user()->toko->countPenyewaanAllBerstatus('ReturAll')[2] == 'naik'): ?>
                                                                <i class="fas fa-arrow-up text-danger"></i>
                                                                <span
                                                                    class="text-danger"><?php echo e(number_format(auth()->user()->toko->countPenyewaanAllBerstatus('ReturAll')[1], 0)); ?>%</span>
                                                            <?php elseif(auth()->user()->toko->countPenyewaanAllBerstatus('ReturAll')[2] == 'turun'): ?>
                                                                <i class="fas fa-arrow-down text-success"></i>
                                                                <span
                                                                    class="text-success"><?php echo e(number_format(auth()->user()->toko->countPenyewaanAllBerstatus('ReturAll')[1], 0)); ?>%</span>
                                                            <?php else: ?>
                                                                <i class="fas fa-minus text-secondary"></i>
                                                                <span
                                                                    class="text-secondary"><?php echo e(auth()->user()->toko->countPenyewaanAllBerstatus('ReturAll')[1]); ?>%</span>
                                                            <?php endif; ?>
                                                        </span>
                                                        <span>Dari bulan lalu
                                                            (<?php echo e(auth()->user()->toko->countPenyewaanAllBerstatus('ReturAll')[3]); ?>
...
<?php echo $__env->make('layout.selllayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Backup data c\kuliah\Semester 8\Tugas Akhir\WEBSITE\Revisi\revisi kalasewa v2\resources\views/pemilikSewa/dashboardToko.blade.php ENDPATH**/ ?>