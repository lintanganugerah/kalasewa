...
<head>
    ...
    <link href="<?php echo e(asset('admincss/img/logo/Logo_Kalasewa.png')); ?>" rel="icon">
    <link href="<?php echo e(asset('admincss/vendor/fontawesome-free/css/all.min.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('admincss/vendor/bootstrap/css/bootstrap.min.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('admincss/css/ruang-admin.min.css')); ?>" rel="stylesheet">
...
<body id="page-top">
    ...
    <script src="<?php echo e(asset('admincss/vendor/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admincss/vendor/jquery-easing/jquery.easing.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admincss/js/ruang-admin.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admincss/vendor/chart.js/Chart.min.js')); ?>"></script>
    <script src="<?php echo e(asset('admincss/js/demo/chart-area-demo.js')); ?>"></script>
...
</html><?php /**PATH E:\Backup data c\kuliah\Semester 8\Tugas Akhir\WEBSITE\Development\Iterasi 3\kalasewa hosting iterasi 3 v1\resources\views/admin/layout/app.blade.php ENDPATH**/ ?>