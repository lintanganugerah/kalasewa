<?php $__env->startSection('content'); ?>
    <div class="row">
        <div class="col">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="<?php echo e(route('seller.pengajuanDendaAction', $order->nomor_order)); ?>" method="POST"
                        ...
                        <div class="m-2">
                            ...
                            <select class="form-select" aria-label="Default select example" id="optionPeraturan"
                                ...
                                <option value="" selected disabled>Pilih Peraturan yang
                                    dilanggar</option>
                                <?php $__currentLoopData = $order->id_produk_order->toko->peraturanSewaToko; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $peraturan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($peraturan->nama == 'Terlambat Mengembalikan Kostum'): ?>
                                    <?php else: ?>
                                        <option value="<?php echo e($peraturan->id); ?>"
                                            data-denda-pasti="<?php echo e($peraturan->denda_pasti); ?>">
                                            <?php echo e($peraturan->nama); ?></option>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            <small>Jika peraturan tidak ada. <a
                                    href="<?php echo e(route('seller.profil.viewTambahPeraturanSewa')); ?>"> klik disini </a> untuk
                                menambahkan</small>
                        </div>
                        <div class="m-2">
...
<?php echo $__env->make('layout.selllayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Backup data c\kuliah\Semester 8\Tugas Akhir\WEBSITE\Development\Iterasi 3\Iterasi 3 kalasewa hosting v2\resources\views/pemilikSewa/iterasi3/denda/pengajuanDenda.blade.php ENDPATH**/ ?>