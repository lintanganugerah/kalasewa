        ...
        <div class="col">
            ...
            <div class="text-left mb-5 mt-3 ml-4">
                ...
                <div class="text-left mt-3 mb-3">
                    <a href="<?php echo e(route('seller.viewProdukAnda')); ?>" class="btn btn-outline kalasewa-color"><i
                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="Informasi" role="tabpanel"
                                ...
                                <?php $__currentLoopData = $fotoProduk->where('id_produk', $produk->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class=" mb-2">
                                        <div class="d-flex align-items-start">
                                            <img class="" src="<?php echo e(asset($fp->path)); ?>"
                                                style="width: 150px; height: 150px; object-fit: cover;" alt="Foto Produk">
                                            <form action="<?php echo e(route('seller.hapusFoto', $fp->id)); ?>" method="POST">
                                                <?php echo csrf_field(); ?>
                                ...
                                <form action="<?php echo e(route('seller.editProdukAction', $produk->id)); ?>" method="POST"
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            name="namaProduk" value="<?php echo e(old('namaProduk', $produk->nama_produk)); ?>"
                                            required>
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleFormControlTextarea1" class="form-label">Deskripsi Produk<span
                                                class="text-danger">*</span></label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="10" name="deskripsiProduk" required><?php echo e(old('deskripsiProduk', $produk->deskripsi_produk)); ?></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Brand<span
                                                class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="exampleFormControlInput1"
                                            name="brand" value="<?php echo e(old('brand', $produk->brand)); ?>" required>
                                        ...
                                        <select class="form-select select2" id="selectSeries" name="series" required>
                                            ...
                                            <?php $__currentLoopData = $series; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($sr->series); ?>"
                                                    <?php echo e(old('series', $produk->series->series) == $sr->series ? 'selected' : ''); ?>>
                                                    <?php echo e($sr->series); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    ...
                                    <div class="form-floating mb-3">
                                        <select class="form-select select2" id="selectGender" name="gender" required>
                                            <option></option>
                                            <option value="Pria"
                                                <?php echo e(old('gender', $produk->gender) == 'Pria' ? 'selected' : ''); ?>>Pria
                                            </option>
                                            <option value="Wanita"
                                                <?php echo e(old('gender', $produk->gender) == 'Wanita' ? 'selected' : ''); ?>>
                                                Wanita</option>
                                            <option value="Semua Gender"
                                                <?php echo e(old('gender', $produk->gender) == 'Semua Gender' ? 'selected' : ''); ?>>
                                                Semua Gender</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-floating mb-3">
                                        <select class="form-select select2" name="ukuran" required>
                                            <option></option>
                                            <option value="XS"
                                                <?php echo e(old('ukuran', $produk->ukuran_produk) == 'XS' ? 'selected' : ''); ?>>
                                                XS
                                            </option>
                                            <option value="S"
                                                <?php echo e(old('ukuran', $produk->ukuran_produk) == 'S' ? 'selected' : ''); ?>>S
                                            </option>
                                            <option value="M"
                                                <?php echo e(old('ukuran', $produk->ukuran_produk) == 'M' ? 'selected' : ''); ?>>M
                                            </option>
                                            <option value="L"
                                                <?php echo e(old('ukuran', $produk->ukuran_produk) == 'L' ? 'selected' : ''); ?>>L
                                            </option>
                                            <option value="XL"
                                                <?php echo e(old('ukuran', $produk->ukuran_produk) == 'XL' ? 'selected' : ''); ?>>
                                                XL
                                            </option>
                                            <option value="XXL"
                                                <?php echo e(old('ukuran', old('ukuran', $produk->ukuran_produk)) == 'XXL' ? 'selected' : ''); ?>>
                                                XXL
                                            </option>
                                            <option value="All_Size"
                                                <?php echo e(old('ukuran', $produk->ukuran_produk) == 'All_Size' ? 'selected' : ''); ?>>
                                                All Size
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="form-floating">
                                            <input type="number" id="hargaInput" class="form-control" name="harga"
                                                placeholder="Harga" value="<?php echo e(old('harga', $produk->harga)); ?>"
                                    ...
                                    <div class="mb-3">
                                        <select class="form-select" name="grade" required>
                                            ...
                                            <option value="Grade 1"
                                                <?php echo e(old('grade', $produk->grade) == 'Grade 1' ? 'selected' : ''); ?>>
                                                Grade 1
                                            </option>
                                            <option value="Grade 2"
                                                <?php echo e(old('grade', $produk->grade) == 'Grade 2' ? 'selected' : ''); ?>>
                                                Grade 2</option>
                                            <option value="Grade 3"
                                                <?php echo e(old('Grade 3', $produk->grade) == 'Grade 3' ? 'selected' : ''); ?>>
                                                Grade 3
                                            </option>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3">
                                        <input type="radio" id="cuciTidak" name="cuci" value="tidak"
                                            onchange="opsiCuci()" <?php echo e(old('cuci') == 'tidak' ? 'checked' : ''); ?>

                                            <?php echo e(old('cuci') == null && $produk->biaya_cuci == null ? 'checked' : ''); ?>

                                            required>
                                        Tidak
                                        <input type="radio" id="cuciYa" name="cuci" value="ya"
                                            onchange="opsiCuci()" <?php echo e(old('cuci') == 'ya' ? 'checked' : ''); ?>

                                            <?php echo e(old('cuci') == null && $produk->biaya_cuci != null ? 'checked' : ''); ?>> Ya
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div id="optionsBiayaCuci" class="mb-3">
                                        ...
                                        <?php if(old('biaya_cuci') || $produk->biaya_cuci): ?>
                                            <div class="mb-2" id="optionsCuci">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" id="biaya_cuci" class="form-control"
                                                        ...
                                                        pattern="[0-9]*"
                                                        value="<?php echo e(old('biaya_cuci', $produk->biaya_cuci)); ?>" required>
                                                </div>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3">
                                        <input type="radio" id="wigTidak" name="wig_opsi" value="tidak"
                                            ...
                                            <?php echo e(old('wig_opsi') == null && $produk->brand_wig == null && $produk->keterangan_wig == null ? 'checked' : ''); ?>

                                            required> Tidak
                                        <input type="radio" id="wigYa" name="wig_opsi" value="ya"
                                            onchange="opsiWig()" <?php echo e(old('wig_opsi') == 'ya' ? 'checked' : ''); ?>

                                            <?php echo e(old('wig_opsi') == null && $produk->brand_wig != null ? 'checked' : ''); ?>>
                                        Ya
                                    </div>
                                    <div id="optionsWig" class="mb-3">
                                        

                                        <?php if(old('brand_wig') || old('ket_wig') || $produk->brand_wig): ?>
                                            <?php if(old('wig_opsi') == 'tidak'): ?>
                                            <?php else: ?>
                                                <div class="mb-2" id="infoWig">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="brand_wig" class="form-control"
                                                            ...
                                                            value="<?php echo e(old('brand_wig', $produk->brand_wig)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" id="ket_wig"
                                                            ...
                                                            value="<?php echo e(old('ket_wig', $produk->keterangan_wig)); ?>"
                                                            required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <?php if($alamatTambahan): ?>
                                        ...
                                        <div class="mb-3">
                                            <input type="radio" id="default_alamat" name="alamat_opsi" value="default"
                                                <?php echo e(old('alamat_opsi') == 'default' ? 'checked' : ''); ?>

                                                <?php echo e($produk->id_alamat == null ? 'checked' : ''); ?> required>
                                            Alamat Utama
                                            <?php $__currentLoopData = $alamatTambahan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $al): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <input type="radio" name="alamat_opsi" value="<?php echo e($al->id); ?>"
                                                    <?php echo e(old('alamat_opsi', $produk->id_alamat) == $al->id ? 'checked' : ''); ?>
                                    ...
                                    <div id="additionalInputs">
                                        <?php if($produk->additional && old('additional') == null): ?>
                                            <?php $__currentLoopData = $decodeAdd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $nama => $harga): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="additional-input mb-3"
                                                    id="additional-<?php echo e($nama); ?>-<?php echo e($loop->iteration); ?>">
                                                    <!-- $loop disediakan oleh laravel untuk cek ini iterasi ke berapa -->
                                                    <div class="fw-bolder fs-5">Additional <span class="btn"
                                                            onclick="removeAdditionalInput('additional-<?php echo e($nama); ?>-<?php echo e($loop->iteration); ?>')"><i
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="additional[]"
                                                            value="<?php echo e($nama); ?>" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="additionalHarga_1">Harga Additional</label>
                                                        <input type="number" pattern="^[0-9]*$"
                                                            class="form-control additional-price"
                                                            id="additionalPrice-<?php echo e($nama); ?>-<?php echo e($loop->iteration); ?>"
                                                            name="additional[]" value="<?php echo e($harga); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="number" class="form-control" id="beratProduk" name="beratProduk"
                                            value="<?php echo e($produk->berat_produk); ?>" pattern="^[0-9]*$" required>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="grab"
                                                ...
                                                <?php echo e(in_array('Grab', json_decode($produk->metode_kirim)) ? 'checked' : ''); ?>>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="goSend"
                                                ...
                                                <?php echo e(in_array('GoSend', json_decode($produk->metode_kirim)) ? 'checked' : ''); ?>>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="jne"
                                                ...
                                                <?php echo e(in_array('JNE', json_decode($produk->metode_kirim)) ? 'checked' : ''); ?>>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="jnt"
                                                ...
                                                <?php echo e(in_array('JNT', json_decode($produk->metode_kirim)) ? 'checked' : ''); ?>>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="SiCepat"
                                                ...
                                                <?php echo e(in_array('SiCepat', json_decode($produk->metode_kirim)) ? 'checked' : ''); ?>>
                                        ...
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="checkbox" id="Paxel"
                                                ...
                                                <?php echo e(in_array('Paxel', json_decode($produk->metode_kirim)) ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layout.selllayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kalasewa/kalasewa/resources/views/produk/editproduk.blade.php ENDPATH**/ ?>