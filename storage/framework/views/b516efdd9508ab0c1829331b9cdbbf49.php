                ...
                <div class="row">
                    ...
                    <div class="d-md-block align-items-center">
                        <div class="card-body p-4 p-lg-5 text-black">
                            ...
                            <form action="<?php echo e(route('registerInformationActionPenyewa')); ?>" method="POST"
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="text" id="form2Example17" class="form-control form-control-lg"
                                        name="nomor_identitas" value="<?php echo e(old('nomor_identitas')); ?>" required />
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <select class="form-select form-select-lg" id="ket_no_darurat" name="ket_no_darurat"
                                        required>
                                        <?php $__currentLoopData = $enumOptions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($option); ?>"
                                                <?php echo e(old('ket_no_darurat') == $option ? 'selected' : ''); ?>><?php echo e($option); ?>
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="text" id="nomor_telpon_darurat" class="form-control form-control-lg"
                                        ...
                                        value="<?php echo e(old('nomor_telpon_darurat')); ?>" required />
                                ...
                                <div class="form-outline mb-4">
                                    <label class="form-label" for="form2Example17">Link Sosial Media<span
                                            class="text-danger">*</span></label>
                                    <input type="text" id="form2Example17" class="form-control form-control-lg"
                                        name="link_sosial_media" value="<?php echo e(old('link_sosial_media')); ?>" required />
                                ...
                                <div data-mdb-input-init class="form-outline mb-4">
                                    <label class="form-label" for="form2Example27">Alamat<span
                                            class="text-danger">*</span></label>
                                    <textarea type="text" id="alamat" class="form-control form-control-lg" name="alamat" required><?php echo e(old('alamat')); ?></textarea>
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <select class="form-select form-select-lg" id="floatingSelect" name="provinsi"
                                        ...
                                        <option value="Jawa Barat"
                                            <?php echo e(old('provinsi') == 'Jawa Barat' ? 'selected' : ''); ?>>
                                            Jawa Barat</option>
                                    </select>
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <select class="form-select form-select-lg" id="floatingSelect" name="kota"
                                        ...
                                        <option value="Kota Bandung"
                                            <?php echo e(old('kota') == 'Kota Bandung' ? 'selected' : ''); ?>>
                                            Kota Bandung</option>
                                        <option value="Kabupaten Bandung"
                                            <?php echo e(old('kota') == 'Kabupaten Bandung' ? 'selected' : ''); ?>>Kabupaten Bandung
                                        </option>
                                    </select>
                                    <div id="provinsi" class="form-text">Mohon maaf saat ini kami hanya melayani wilayah
                                        bandung saja</div>
...
<?php echo $__env->make('layout.layout-seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kalasewa/kalasewa/resources/views/authentication/register-penyewa-informasi.blade.php ENDPATH**/ ?>