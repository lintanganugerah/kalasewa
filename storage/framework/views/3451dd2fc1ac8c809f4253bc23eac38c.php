                    ...
                    <div class="card">
                        <div class="card-header">
                            <ul class="nav nav-tabs card-header-tabs" id="historyTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active" aria-current="page" href="<?php echo e(route('viewHistoryPenyewaanSelesai')); ?>">Penyewaan
                                        Selesai</a>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <table class="table w-100" id="table-history">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <?php if($order->status == 'Penyewaan Selesai' or $order->status == 'Retur Selesai'): ?>
                                                    <tr>
                                                        ...
                                                        <?php endif; ?>
                                                        <td>
                                                            <?php if($order->status == 'Penyewaan Selesai'): ?>
                                                                Penyewaan Selesai
                                                            <?php elseif($order->status == 'Retur Selesai'): ?>
                                                                Retur Selesai
                                                            <?php endif; ?>
                                                        </td>
                                                        <td>
                                                            <a class="btn btn-danger w-100" href="<?php echo e(route('viewPenyewaanSelesai', ['orderId' => $order->nomor_order])); ?>">Detail</a>
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kalasewa/kalasewa/resources/views/penyewa/history/penyewaanselesai.blade.php ENDPATH**/ ?>