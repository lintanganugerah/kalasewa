                ...
                <div class="row gx-lg-5 align-items-center">
                    <div class="col-md-6">
                        <div class="p-5 text-start rounded-3">
                            ...
                            <div class="mb-5">
                                <a href="<?php echo e(route('registerViewPemilikSewa')); ?>">
                    ...
                    <div class="col-md-6 text-center">
                        <img src="<?php echo e(asset('img/kalasewa_logo_big.png')); ?>" width="300px" alt="Logo">
                    </div>
                </div>
...
<?php echo $__env->make('layout.layout-seller', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kalasewa/kalasewa/resources/views/jadiseller.blade.php ENDPATH**/ ?>