    ...
    <div class="email-container"
        ...
        <div class="email-body">
            ...
            <div style="text-align: center; margin: 20px 0;">
                <a href="<?php echo e($actionUrl); ?>" class="button" target="_blank">Reset Kata Sandi</a>
            </div>
            <p>Link buat reset kata sandi ini bakal kadaluarsa dalam waktu
                <?php echo e(config('auth.passwords.' . config('auth.defaults.passwords') . '.expire')); ?> menit. Jadi, buruan ya!
            </p>
            <p>Kalo kamu nggak ngerasa minta reset kata sandi, abaikan aja email ini. Nggak usah khawatir!</p>
            <p>Cheers, tim <?php echo e(config('app.name')); ?></p>
        </div>
        <div class="email-footer" style="text-align: center; margin-top: 20px;">
            <p class="small-text">Kalo kamu kesulitan buat klik tombol "Reset Kata Sandi", copy dan paste URL di bawah
                ini ke browser kamu: <a href="<?php echo e($actionUrl); ?>"><?php echo e($actionUrl); ?></a></p>
            <p class="text-center">&copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. All rights reserved.</p>
        </div>
...
</html><?php /**PATH /home/kalasewa/kalasewa/resources/views/vendor/notifications/email.blade.php ENDPATH**/ ?>