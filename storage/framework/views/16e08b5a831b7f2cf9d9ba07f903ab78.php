                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane fade show active" id="Informasi" role="tabpanel"
                                ...
                                <?php endif; ?>
                                <form action="<?php echo e(route('seller.profil.TambahPeraturanSewaAction')); ?>" id="formproduk"
...
<?php echo $__env->make('layout.selllayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/kalasewa/kalasewa/resources/views/pemilikSewa/iterasi2/peraturanSewa/tambahPeraturanSewaToko.blade.php ENDPATH**/ ?>