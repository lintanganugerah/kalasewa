                        ...
                        <ul class="nav nav-tabs card-header-tabs" id="historyTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link text-secondary"
                                    href="<?php echo e(route('viewHistoryMenungguDiproses')); ?>">Menunggu Konfirmasi
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page"
                                    href="<?php echo e(route('viewHistoryDalamPengiriman')); ?>">Dalam
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-secondary"
                                    href="<?php echo e(route('viewHistorySedangBerlangsung')); ?>">Sedang
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-secondary"
                                    href="<?php echo e(route('viewHistoryDibatalkan')); ?>">Dibatalkan
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-secondary"
                                    href="<?php echo e(route('viewHistoryPenyewaanSelesai')); ?>">Penyewaan
                                    Selesai</a>
                            </li>
                        </ul>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-danger w-100"
                                                href="<?php echo e(route('viewDetailPemesanan', ['orderId' => $order->nomor_order])); ?>">Detail</a>

                                            <a href="<?php echo e(url('/chat' . '/' . $order->toko->id_user)); ?>" target="_blank"
                                            ...
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h1 class="modal-title fs-5"
                                                        id="resiModalLabel-<?php echo e($loop->iteration); ?>">
                                                        Bukti
                                                        Resi</h1>
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <p>Ongkos Kirim:
                                                        <strong>Rp<?php echo e(number_format($order->ongkir_pengiriman, 0, '', '.')); ?></strong>
                                                    </p>
                                                    <img src="<?php echo e(asset($order->bukti_resi)); ?>" alt="Resi"
...
<?php echo $__env->make('layout.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Backup data c\kuliah\Semester 8\Tugas Akhir\WEBSITE\Development\Iterasi 3\kalasewa hosting iterasi 3 v1\resources\views/penyewa/history/dalampengiriman.blade.php ENDPATH**/ ?>